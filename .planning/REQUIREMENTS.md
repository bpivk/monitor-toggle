...
- [ ] **ICON-01**: The tray icon pair (rig mode / normal mode) uses genuinely distinct silhouettes, not just a color swap, so the two modes are distinguishable even to colorblind users
- [ ] **ICON-02**: Tray icons are legible at the actual 16x16 tray size and remain visible against both light and dark taskbar backgrounds
