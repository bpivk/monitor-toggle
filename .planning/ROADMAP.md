...
**Plans**: 3 plans (2 waves of implementation + 1 rig verification checkpoint)
  - [ ] 13-01-PLAN.md — RigToggle.IconGen dev-time generator (GDI+ geometry + hand-rolled multi-frame .ico writer) → regenerated normal.ico/rig.ico + new color app.ico
...
| 13. Tray & App Icon Redesign | v1.2 | 0/3 | Not started | - |
