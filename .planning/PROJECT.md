...
---
*Last updated: 2026-07-31 — Phase 8 (Tray Residency, Autostart & Toast Notification) complete: tray residency, autostart, and toast notification all rig-validated (including a genuine `--tray` hidden-start bug found, fixed, and retested), code-reviewed clean.*
